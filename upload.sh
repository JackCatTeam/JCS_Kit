...
# 提交到私有库
pod repo push JCS_PodSpecs JCS_Kit.podspec --sources=${gitsource} --verbose --allow-warnings --use-libraries --use-modular-headers
#提交到公开库
#pod trunk push JCS_Kit.podspec --verbose --allow-warnings --use-libraries
