//
//  MASConstraintMaker+JCS_Extension.h
//  JCS_Kit
//
...
@interface MASConstraintMaker (JCS_Extension)
...
@property (nonatomic, copy,readonly) MASConstraint*(^jcs_center_e)(CGPoint value);
...
@property (nonatomic, copy,readonly) MASConstraint*(^jcs_edges_e)(UIEdgeInsets value);
...
@property (nonatomic, copy,readonly) MASConstraint*(^jcs_center_r)(id value);
...
@property (nonatomic, copy,readonly) MASConstraint*(^jcs_edges_r)(id value);
